...
Prepare an existing owner-only parent directory before generating a book key. FinGrind refuses to
create, follow, or weaken the selected secret parent directory. Standalone attestation credential
generation likewise requires an existing non-symbolic-link parent directory.
...
journal in either surface. A plan that contains any mutation requires one through 64 aligned
attestation credential triplets under an explicit custody selection; a query-only or
assertion-only plan does not. A mutating plan
...
`protocolVersion` field. The current hard-break line is `"34"`.
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>open-book</code></td><td>none</td><td><code>--book-file &lt;path&gt;</code><br><code>--book-key-file &lt;path&gt; | --book-passphrase-stdin | --book-passphrase-prompt</code><br><code>--entity-name &lt;text&gt;</code><br><code>--book-template-id &lt;OWNER_MANAGED_SERVICE|OWNER_MANAGED_TRADING&gt;</code><br><code>--accounting-basis &lt;CASH|ACCRUAL&gt;</code><br><code>[--inventory-costing &lt;WEIGHTED_AVERAGE&gt;] (required for OWNER_MANAGED_TRADING)</code><br><code>--functional-currency &lt;currency-code&gt;</code><br><code>--fiscal-year-start &lt;MM-DD&gt;</code><br><code>--book-start-effective-date &lt;YYYY-MM-DD&gt;</code><br><code>--attestation-custodian &lt;file-pkcs8&gt;</code><br><code>--attestation-founder-principal-id &lt;uuid&gt; (repeat one through five aligned founder credential triplets under the selected custody)</code><br><code>--attestation-founder-key-file &lt;path&gt; (repeat one through five aligned founder credential triplets under the selected custody)</code><br><code>--attestation-founder-passphrase-file &lt;path&gt; (repeat one through five aligned founder credential triplets under the selected custody)</code><br><code>[--tighten-parents]</code><br><code>[--output &lt;json|text&gt;]</code></td><td>Initialize a new book file with the canonical schema, selected seed template, explicit accounting basis, and the inventory costing doctrine required by trading templates.</td></tr>
