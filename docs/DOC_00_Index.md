...
| `DOC_00_TaxAdministration.md` | tax-registration, tax-obligation, and tax-contract symbol-routing continuation |
...
Tax-registration, tax-obligation, and tax-contract symbols continue in
[DOC_00_TaxAdministration.md](./DOC_00_TaxAdministration.md).
...
| `PdfReportCapabilityDescriptorProjection` | `DOC_02_MachineContractAndDescriptors.md` | `PdfReportCapabilityDescriptorProjection` |
