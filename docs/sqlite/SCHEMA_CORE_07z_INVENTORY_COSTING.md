...
# SQLite Schema: Inventory Costing
...
**Generation**: This page is rendered from the canonical schema file by `scripts/render-sqlite-schema-doc.py`. **Coverage**: `inventory_movement`, `inventory_on_hand`, and inventory-costing validation triggers.
