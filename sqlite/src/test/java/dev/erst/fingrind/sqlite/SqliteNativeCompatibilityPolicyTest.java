...
class SqliteNativeCompatibilityPolicyTest extends SqliteNativeBridgeTestSupport {
  ...
  void requireSupportedVersion_rejectsOlderRuntimeAndCompareVersionsOrdersDottedNumbers() {
    assertTrue(SqliteNativeCompatibilityPolicy.compareVersions("3.53.4", "3.52.9") > 0);
    assertEquals(-1, SqliteNativeCompatibilityPolicy.compareVersions("3.53", "3.53.4"));
    assertEquals(1, SqliteNativeCompatibilityPolicy.compareVersions("3.53.4", "3.53"));
    assertThrows(
        IllegalStateException.class,
        () -> SqliteNativeCompatibilityPolicy.compareVersions("3.bad.0", "3.53.4"));
    ...
    assertEquals("3.53.4", exception.requiredMinimumVersion());
