...
class SqliteNativeCompatibilityPolicyTest extends SqliteNativeBridgeTestSupport {
  ...
  void requireSupportedVersion_rejectsOlderRuntimeAndCompareVersionsOrdersDottedNumbers() {
    assertTrue(SqliteNativeCompatibilityPolicy.compareVersions("3.53.3", "3.52.9") > 0);
    assertEquals(-1, SqliteNativeCompatibilityPolicy.compareVersions("3.53", "3.53.3"));
    assertEquals(1, SqliteNativeCompatibilityPolicy.compareVersions("3.53.3", "3.53"));
    assertThrows(
        IllegalStateException.class,
        () -> SqliteNativeCompatibilityPolicy.compareVersions("3.bad.0", "3.53.3"));
    ...
    assertEquals("3.53.3", exception.requiredMinimumVersion());
  ...
  void requireSupportedSqlite3mcVersion_rejectsUnexpectedRuntime() {
    ...
    assertEquals("2.3.6", exception.requiredVersion());
    assertEquals("managed-only", exception.libraryMode());
  }
  ...
  void requireSupportedSourceId_rejectsUnexpectedRuntimeAndAcceptsCanonicalPin() {
    ...
    UnsupportedSqliteSourceIdException exception =
        assertThrows(
            ...
            () ->
                SqliteNativeCompatibilityPolicy.requireSupportedSourceId(
                    "2026-04-09 unexpected-source-id", "managed-only", "3.53.3", "2.3.6"));
