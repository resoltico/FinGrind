...
public final class BookFormatContract {
  ...
  public static final int APPLICATION_ID = ProtocolCatalog.protectedBookFormat().applicationId();

  /** Stable on-disk FinGrind book-format version supported by the current public line. */
  public static final int FORMAT_VERSION = ProtocolCatalog.protectedBookFormat().formatVersion();
