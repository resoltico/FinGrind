...
final class MachineContractDomainDescriptors {
  ...
  static BookModelDescriptor bookModel() {
  ...
  static AccountRegistryDescriptor accountRegistry() {
    return new AccountRegistryDescriptor(
        InitializationRequirement.REQUIRES_OPEN_BOOK,
        ...
        List.of(
            ...
            new FieldDescriptor("accountType", "Declared account classification."),
            new FieldDescriptor("accountNodeKind", "Declared chart node kind."),
            new FieldDescriptor(
  ...
  static ReversalDescriptor reversals() {
  ...
  static PreflightDescriptor preflight() {
    ...
    return new PreflightDescriptor(
        preflight.semantics(),
        CommitGuarantee.fromGuaranteed(preflight.commitGuarantee()),
        preflight.description());
  }

  static CurrencyDescriptor currencyModel() {
