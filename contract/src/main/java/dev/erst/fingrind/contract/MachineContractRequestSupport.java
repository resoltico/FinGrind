...
/** Builds request-input and request-shape descriptors for the machine contract. */
final class MachineContractRequestSupport {
  private MachineContractRequestSupport() {}
