  ...
  private static List<RequestSurfaceFacts.PostEntryKindFacts> postEntryKinds() {
    return List.of(
        entryKindFacts(
            ...
            "Operational journal writes accept either direct balanced lines or one named journal recipe; the reachability matrix publishes the exact account-classification cells that remain writable through this path after kernel reservations are applied."),
        entryKindFacts(
