...
final class ReportModelDisplay {
  private static final Map<PostingOriginKind, String> POSTING_ORIGIN_LABELS =
      Map.ofEntries(
          ...
          Map.entry(PostingOriginKind.LATVIAN_MONTHLY_PAYROLL, "Latvian monthly payroll"),
          Map.entry(
          ...
          Map.entry(PostingOriginKind.FIXED_ASSET_CAPITALIZATION, "Fixed-asset capitalization"),
          Map.entry(PostingOriginKind.FIXED_ASSET_DEPRECIATION, "Fixed-asset depreciation"),
          Map.entry(PostingOriginKind.FIXED_ASSET_DISPOSAL, "Fixed-asset disposal"),
          Map.entry(PostingOriginKind.FINANCING_BORROWING, "Financing borrowing"),
          Map.entry(
              PostingOriginKind.FINANCING_PRINCIPAL_REPAYMENT, "Financing principal repayment"),
          Map.entry(PostingOriginKind.FINANCING_INTEREST_ACCRUAL, "Financing interest accrual"),
          Map.entry(PostingOriginKind.FINANCING_INTEREST_PAYMENT, "Financing interest payment"),
          Map.entry(PostingOriginKind.FOREIGN_CURRENCY_OBLIGATION, "Foreign-currency obligation"),
          Map.entry(
