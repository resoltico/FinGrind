...
public enum PostingKind implements WireValue {
  ...
  /** Returns the posting kinds that callers may submit through the public posting command. */
  public static List<String> callerSelectableWireValues() {
    return List.of(STANDARD.wireValue(), OPENING_BALANCE.wireValue());
  }
  ...
  public boolean isGenerated() {
    return this == PERIOD_CLOSE;
  }

  /** Returns whether this posting kind belongs to the public caller-authored posting surface. */
  public boolean isCallerSelectable() {
    return !isGenerated();
  }
}
