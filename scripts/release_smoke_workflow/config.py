...
def load_config() -> ReleaseSmokeConfig:
    ...
    return ReleaseSmokeConfig(
        ...
        declare_asset_supplement=scenario.declare_asset_supplement,
        ...
        asset_supplement_account_code=scenario.asset_supplement_account_code,
        asset_supplement_account_name=scenario.asset_supplement_account_name,
