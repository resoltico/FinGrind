...
SECTIONS = [
    ...
    SchemaSection(
        ...
        file_name="SCHEMA_CORE_07z_INVENTORY_COSTING.md",
        title="SQLite Schema: Inventory Costing",
        purpose="Durable inventory movement replay, materialized on-hand state, and inventory-account admission gates.",
        coverage="`inventory_movement`, `inventory_on_hand`, and inventory-costing validation triggers.",
        domain="SQLITE_SCHEMA_CORE_INVENTORY_COSTING",
    ),
    SchemaSection(
...
TABLE_SECTION_BY_NAME = {
    ...
    "inventory_movement": "inventory-costing",
    "inventory_on_hand": "inventory-costing",
...
TRIGGER_SECTION_BY_PREFIX = (
    ...
    ("inventory_movement_validate_", "inventory-costing"),
    ("inventory_movement_reject_", "indexes-and-immutability"),
    ("inventory_on_hand_validate_", "inventory-costing"),
