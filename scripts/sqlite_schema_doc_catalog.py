...
SECTIONS = [
    ...
    SchemaSection(
        key="account-declaration-rules",
        file_name="SCHEMA_CORE_03_ACCOUNT_DECLARATION_RULES.md",
        title="SQLite Schema: Account Declaration Rules",
        purpose="Parent-shape and contra-relationship admission rules when accounts are declared.",
        coverage="Account parent and contra-account validation triggers on insert.",
        domain="SQLITE_SCHEMA_CORE_ACCOUNT_DECLARATION_RULES",
    ),
    SchemaSection(
        key="account-lifecycle-rules",
        file_name="SCHEMA_CORE_03a_ACCOUNT_LIFECYCLE_RULES.md",
        title="SQLite Schema: Account Lifecycle Rules",
        purpose="Account amendment, retirement, relationship-mutation, and deletion safeguards.",
        coverage="Account validation triggers on update and append-only delete rejection.",
    ...
    SchemaSection(
        ...
        file_name="SCHEMA_CORE_13zf_LATVIAN_PAYROLL_SETTLEMENTS.md",
        title="SQLite Schema: Latvian Payroll Settlements",
        purpose="Immutable Latvian payroll-obligation settlements and compensating reversals.",
        coverage="`latvian_payroll_settlement`, `latvian_payroll_settlement_reversal`, and settlement validation/append-only triggers.",
