...
grep -Fq 'ORG_GRADLE_PROJECT_fingrindTestTemporaryDirectory' "${verifier_entry}" || die \
    'native Windows verifier no longer supplies its private test directory through Gradle project properties'
