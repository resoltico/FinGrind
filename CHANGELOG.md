...
- Fixed release-verification null-payload handling so the public-release PR gate now treats an absent GitHub workflow run as pending evidence instead of crashing before the aggregate `Gate` materializes.
